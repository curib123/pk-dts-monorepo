...
@Component({
    ...
    styles: [
        ...
        `
        ,`
            /* SaaS auth refinement: shared shell, clearer onboarding hierarchy, and calmer status states. */
            .registration-shell {
                min-height: 100svh;
            ...
            .registration-overlay {
                left: auto;
                width: 43%;
                background: linear-gradient(145deg, rgba(15, 23, 42, 0.9), rgba(127, 29, 29, 0.7));
            }
            ...
            .landing-nav .nav-link { color: #64748b; }
            .landing-nav .nav-link:hover { color: #172033; background: #f1f5f9; }
            .landing-nav .landing-nav-meta {
                border: 1px solid #e2e8f0;
                background: #fff;
                color: #475569;
                box-shadow: 0 6px 16px rgba(15, 23, 42, 0.05);
            }
            .landing-nav .landing-nav-meta i { color: var(--registration-brand); }
            ...
            .registration-intro {
                ...
                flex-direction: column;
                justify-content: space-between;
                background: linear-gradient(160deg, rgba(15, 23, 42, 0.42), rgba(15, 23, 42, 0.9));
                color: #fff;
            }

            .registration-intro header { align-items: center; }
            .registration-intro .logo-frame { flex: 0 0 auto; }
            .registration-intro .brand-copy strong { color: #fff; font-size: 0.95rem; }
            .registration-intro .brand-copy span { color: rgba(255, 255, 255, 0.62); }
            .intro-copy { margin-top: auto; padding-top: 5rem; }
            .intro-copy .eyebrow {
                display: inline-flex;
                width: max-content;
            ...
            .intro-copy h1 { max-width: 21rem; margin-top: 1rem; color: #fff; font-size: clamp(2rem, 3.5vw, 3.15rem); line-height: 1.02; }
            .intro-copy p { max-width: 22rem; color: rgba(255, 255, 255, 0.75); font-size: 0.9rem; line-height: 1.7; }
            .process-list { display: grid; gap: 0.65rem; margin-top: 2rem; }
            .process-list > div {
                display: grid;
            ...
            .process-list b { display: grid; place-items: center; width: 1.8rem; height: 1.8rem; border-radius: 0.55rem; background: rgba(255, 255, 255, 0.14); font-size: 0.72rem; }
            .process-list span { display: grid; gap: 0.1rem; }
            .process-list strong { color: #fff; font-size: 0.76rem; }
            .process-list small { color: rgba(255, 255, 255, 0.58); font-size: 0.65rem; line-height: 1.35; }
            .privacy-note { margin-top: 2rem; border-top: 1px solid rgba(255, 255, 255, 0.18); padding-top: 1rem; }
            .privacy-note i { color: #86efac; }
            .privacy-note small { color: rgba(255, 255, 255, 0.6); }
            ...
            .content-heading > span { color: var(--registration-brand); font-size: 0.64rem; font-weight: 900; letter-spacing: 0.14em; text-transform: uppercase; }
            .content-heading h2 { margin-top: 0.45rem; color: #172033; font-size: 1.75rem; letter-spacing: -0.035em; }
            .content-heading p { max-width: 31rem; margin-top: 0.4rem; color: #7b8495; font-size: 0.86rem; line-height: 1.6; }
            .mode-tabs { margin: 1.5rem 0 1.75rem; border: 1px solid #e6eaf0; border-radius: 0.8rem; background: #f8fafc; padding: 0.25rem; }
            ...
            .section-label i { display: grid; place-items: center; width: 1.8rem; height: 1.8rem; border-radius: 0.55rem; background: var(--registration-brand-soft); color: var(--registration-brand-deep); }
            .section-label span { display: grid; gap: 0.1rem; }
            .section-label strong { color: #334155; font-size: 0.78rem; }
            .section-label small { color: #94a3b8; font-size: 0.68rem; }
            .form-grid label > span, .status-form label > span { color: #475569; font-size: 0.76rem; }
            ...
            .primary { min-height: 3rem; border-radius: 0.7rem; background: var(--registration-brand-deep); box-shadow: 0 12px 24px color-mix(in srgb, var(--registration-brand-deep) 18%, transparent); }
            .primary:hover { background: var(--registration-brand); }
            .error { border: 1px solid #fee2e2; border-radius: 0.75rem; background: #fff5f5; color: #b91c1c; font-size: 0.78rem; }
            .status-form { gap: 0.85rem; }
            .lookup-message { border: 1px solid #e6eaf0; border-radius: 0.75rem; background: #f8fafc; }
            .lookup-message.found { border-color: #bbf7d0; background: #f0fdf4; }
            .lookup-message.missing { border-color: #fed7aa; background: #fff7ed; }
            .status-guide { border: 1px solid #dbeafe; border-radius: 0.8rem; background: #eff6ff; color: #1e40af; }
            .receipt, .status-result { border: 1px solid #e6eaf0; border-radius: 1rem; background: #f8fafc; padding: 1.5rem; }
            .receipt code { border-color: #fecaca; border-radius: 0.7rem; background: #fff; }
            .status-result dl div { border: 1px solid #edf0f4; background: #fff; }
            .registration-content > footer { border-top: 1px solid #edf0f4; padding-top: 1.1rem; }

            @media (max-width: 900px) {
                .registration-cover, .registration-overlay { width: 100%; }
                .registration-cover { height: 34%; bottom: auto; }
                .registration-overlay { height: 34%; bottom: auto; }
                .registration-card { grid-template-columns: 1fr; width: min(700px, 100%); }
                .registration-intro { min-height: auto; padding: 2rem; }
            ...
            @media (max-width: 620px) {
                .registration-shell { padding: 5.8rem 0.75rem 1rem; }
                .landing-nav .landing-nav-actions { gap: 0.35rem; }
                .landing-nav .nav-link span, .landing-nav .landing-nav-meta span { display: none; }
                .landing-nav .landing-nav-meta { width: 2.45rem; height: 2.45rem; justify-content: center; padding: 0; }
                .registration-card { border-radius: 1.15rem; }
                .registration-intro { padding: 1.55rem 1.25rem; }
                ...
                .result-actions a, .result-actions button { text-align: center; }
            }
        `
    ]
})
