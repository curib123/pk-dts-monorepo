...
@Component({
    ...
    `,
    styles: [`
        :host{display:block}.profile-page{display:grid;gap:1rem;color:#172033}.profile-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem;border-radius:1.25rem;background:#fff;padding:1.35rem 1.5rem;box-shadow:0 10px 30px rgba(15,23,42,.06)}.eyebrow{color:var(--brand-primary-deep);font-size:.68rem;font-weight:900;letter-spacing:.14em}.profile-heading h1{margin:.25rem 0 .35rem;font-size:1.8rem}.profile-heading p{max-width:48rem;margin:0;color:#64748b;font-size:.82rem;line-height:1.55}.role-pill{border-radius:999px;background:var(--brand-soft);padding:.55rem .8rem;color:var(--brand-primary-deep);font-size:.72rem;font-weight:850}.feedback,.loading{display:flex;align-items:center;gap:.6rem;border-radius:.8rem;padding:.8rem 1rem}.feedback.error{background:var(--brand-soft);color:var(--brand-primary-deep)}.feedback.success{background:#ecfdf5;color:#166534}.loading{background:#fff;color:#64748b}.profile-card{display:grid;grid-template-columns:minmax(15rem,19rem) minmax(0,1fr);gap:1rem}.identity-card,.form-section{border-radius:1.25rem;background:#fff;padding:1.25rem;box-shadow:0 10px 30px rgba(15,23,42,.05)}.identity-card{align-self:start;display:grid;gap:1rem}.avatar{display:grid;place-items:center;width:3rem;height:3rem;border-radius:1rem;background:var(--brand-soft);color:var(--brand-primary-deep);font-size:1.3rem}.identity-card strong{display:block;font-size:1.08rem}.identity-card span{display:block;margin-top:.2rem;color:#64748b;font-size:.78rem}.identity-card dl{display:grid;gap:.7rem;margin:0}.identity-card dl div{border-top:1px solid #eef2f7;padding-top:.7rem}.identity-card dt{color:#94a3b8;font-size:.67rem;font-weight:850;text-transform:uppercase;letter-spacing:.08em}.identity-card dd{margin:.2rem 0 0;color:#334155;font-size:.8rem;font-weight:750}.form-section{display:grid;gap:1rem}.section-copy h2{margin:0;font-size:1.2rem}.section-copy p{margin:.25rem 0 0;color:#64748b;font-size:.78rem}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.8rem}.form-grid label{display:grid;gap:.35rem}.form-grid label.wide{grid-column:1/-1}.form-grid label>span{color:#475569;font-size:.72rem;font-weight:800}.form-grid small{color:#94a3b8;font-weight:650}.form-grid input{width:100%;box-sizing:border-box;border:1px solid #dbe4ee;border-radius:.75rem;background:#f8fafc;padding:.75rem .8rem;color:#172033;outline:0}.form-grid input:focus{border-color:var(--brand-primary-deep);background:#fff;box-shadow:0 0 0 3px rgba(153,27,27,.08)}.actions{display:flex;justify-content:flex-end;gap:.65rem;border-top:1px solid #eef2f7;padding-top:1rem}.actions button{display:inline-flex;align-items:center;gap:.45rem;border:0;border-radius:.75rem;padding:.7rem .9rem;font-weight:850;cursor:pointer}.actions button:disabled{cursor:not-allowed;opacity:.55}.secondary{background:#eef2f7;color:#475569}.primary{background:var(--brand-primary-deep);color:#fff}@media(max-width:760px){.profile-card{grid-template-columns:1fr}.form-grid{grid-template-columns:1fr}.form-grid label.wide{grid-column:auto}.profile-heading{flex-direction:column}}
    `]
})
