    ...
    template: `
        <section class="transfer-page">
            ...
            <section *ngIf="!reviewerMode && formOpen" class="surface-card request-form">
                ...
                <div class="form-grid">
                    <label><span>Document ID</span><input [(ngModel)]="form.document_id" placeholder="Enter hardcopy document ID" /></label>
                    <label><span>Destination location ID</span><input [(ngModel)]="form.destination_location_id" placeholder="Required storage location ID" /></label>
                    <label><span>Destination area ID</span><input [(ngModel)]="form.destination_area_id" placeholder="Optional" /></label>
                    <label><span>Destination specific ID</span><input [(ngModel)]="form.destination_specific_id" placeholder="Optional" /></label>
                    <label><span>Destination sequence ID</span><input [(ngModel)]="form.destination_sequence_id" placeholder="Optional" /></label>
                    <label><span>Transfer destination</span><input [(ngModel)]="form.transfer_to" placeholder="Example: QA Records Room" /></label>
...
export class HardcopyTransfersPage implements OnInit {
    ...
    resetForm() { this.form = { document_id: '', destination_location_id: '', reason: '' }; }
